...
def train_predict_plot(file_name, df, ml_model):
    ...
    # Dynamically call each model method from utils
...
# Example usage:
# dates, prices, outputs, predict_date, test_price = train_predict_plot('GOOG_30_days.csv', df, ['LSTM_model', 'elastic_net', 'BR'])
# create_plot(dates, prices, outputs)
